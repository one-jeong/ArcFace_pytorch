...
def define_argparser():
    ...
    # p.add_argument('--nc', dest='num_classes', type=int, default=600)
    ...
    # p.add_argument('--train_txt', type=str, default='./dataset/ai_hub_600_train.txt')
    # p.add_argument('--valid_txt', type=str, default='./dataset/ai_hub_600_valid.txt')
